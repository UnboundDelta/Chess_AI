...
def main():
    ...
    while running:
            ...
            # mouse handler
                ...
                if not gameOver and humanTurn:
                    ...
                    if sqSelected == (row, col) or col >= 8:
                        sqSelected = () #deselect
                        playerClicks = [] #clear player clics
                    else:
                        sqSelected = (row, col)
        ...
        drawGameState(screen, gs, validMoves, sqSelected, moveLogFont=moveLogFont)
...
'''
Draw the squares on the board. The top left square is white
'''
